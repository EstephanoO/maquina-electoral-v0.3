...
const ICON_BLUR_SCALE_RANGE_COMPREHENSIVE_MAX = 1.3;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-xs sm:text-sm text-zinc-500">Powered by</span>
          <span className="text-sm sm:text-base bg-gradient-to-r from-amber-400 to-amber-500 bg-clip-text text-transparent font-semibold">
            Goberna
          </span>
