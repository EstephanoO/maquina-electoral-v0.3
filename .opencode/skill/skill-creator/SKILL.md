...
| Project-specific | `{project}-{component}` | `maquina-ui`, `maquina-api` |
| Testing skill | `{project}-test-{component}` | `maquina-test-ui` |
...
Generic skill needs project info?  → Add references/ pointing to local docs
```
